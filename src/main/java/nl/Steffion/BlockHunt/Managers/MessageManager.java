...
public class MessageManager {
	...
	public static void sendMessage(Player player, String message, String... vars) {
		if (player == null) {
			...
			player.sendMessage(MessageManager.replaceAll(message.replaceAll("%player%", player.getName()), vars));
		}
	}
	...
	public static void sendFMessage(Player player, ConfigC location, String... vars) {
		if (player == null) {
			...
			player.sendMessage(MessageManager.replaceAll(location.config.getFile().get(location.location).toString().replaceAll("%player%", player.getName()), vars));
		}
	}
