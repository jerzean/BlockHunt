...
public class Arena implements ConfigurationSerializable {
    ...
    public Arena(String arenaName, Location pos1, Location pos2, int maxPlayers, int minPlayers, int amountSeekersOnStart,
                 ...
                 List<Player> playersInArena, ArenaState gameState, int timer, List<Player> seekers, Scoreboard scoreboard, String lastSeekers) {
        ...
        this.lastSeekers = UUID.fromString(lastSeekers);
        this.team = scoreboard.registerNewTeam(arenaName);
    ...
    public static Arena deserialize(Map<String, Object> map) {
        ...
        return new Arena(
                ...
                (String) map.getOrDefault("lastSeekers", UUID.randomUUID().toString())
        );
    }
    ...
    public Map<String, Object> serialize() {
        ...
        map.put("lastSeekers", lastSeekers.toString());
        return map;
    }
